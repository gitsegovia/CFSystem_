        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl fullWidth sx={{ mb: 6 }}>
            <Controller
              ...
              control={control}
              rules={{ required: true }}
              render={({ field: { value, onChange } }) => <TextField type="email" value={value} label="Correo" onChange={onChange} placeholder="johndoe@email.com" error={Boolean(errors.email)} />}
            />
          ...
          <FormControl fullWidth sx={{ mb: 6 }}>
            <Controller
              ...
              control={control}
              rules={{ required: true }}
              render={({ field: { value, onChange } }) => <TextField type="password" value={value} label="Contraseña" onChange={onChange} placeholder="" error={Boolean(errors.password)} />}
            />
