...
const UserViewLeft = ({ infoTeacher }: Props) => {
    // ** States
    const [openEdit, setOpenEdit] = useState<boolean>(false)
    const [suspendDialogOpen, setSuspendDialogOpen] = useState<boolean>(false)
    const [info, setInfo] = useState(infoTeacher)
                        ...
                        <CardContent>
                            ...
                            <Box sx={{ pt: 2, pb: 1 }}>
                                ...
                                <Box sx={{ display: "flex", mb: 2.7 }}>
                                    ...
                                    <Typography variant="body2">{info.scale}</Typography>
                                </Box>
                                <Box sx={{ display: "flex", mb: 2.7 }}>
                                    <Typography sx={{ mr: 2, fontWeight: 500, fontSize: "0.875rem" }}>Dedicación:</Typography>
                                    <Typography variant="body2">{info.dedication}</Typography>
                                </Box>
                            </Box>
                        </CardContent>
